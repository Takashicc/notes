...
## Show preview thumbnails in mpv's OSC seekbar
...
Add the below content into `~/.config/mpv/lua-settings/mpv_thumbnail_script.conf`.
...
Add the below content into `~/.config/mpv/mpv.conf`.
